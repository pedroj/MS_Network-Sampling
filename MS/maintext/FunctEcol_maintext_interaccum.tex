...
\date{*Corresponding author: jordano@ebd.csic.es}
%
\begin{document}
\maketitle
\section*{Summary}
...
\begin{equation}
P(X)= \frac{(N_X + 1)}{T}\centerdot(1-\frac{E(1)}{T})
\end{equation}
